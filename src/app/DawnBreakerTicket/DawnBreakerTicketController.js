...
import { DawnBreakerTicket } from '../../config/dune';
...
class DawnBreakerTicketController {
  ...
  async generateFile() {
    const NUMBER_OF_PAGES = DawnBreakerTicket.pages;
    const NUMBER_OF_FARMS = DawnBreakerTicket.farms;
    const ua =
    ...
    try {
      await page.goto(DawnBreakerTicket.url, {
